...
# ==============================================================================
cat("\n[1/7] Installing Pharmaverse packages...\n")
...
pharmaverse_packages <- c(
  ...
  "logrx",        # Execution logging for audit trail
  "pkglite",      # Package bundling for eSub
  "sdtmchecks",   # SDTM validation checks
  "pharmaverseadam",   # Synthetic ADaM data for testing
  "pharmaversesdtm"    # Synthetic SDTM data for testing
)

# Install from pharmaverse R-universe
install.packages(
...
# 2. Data I/O Packages
# ==============================================================================
cat("\n[2/7] Installing Data I/O packages...\n")
...
# ==============================================================================
cat("\n[3/7] Installing Tidyverse packages...\n")
...
# ==============================================================================
cat("\n[4/7] Installing Validation packages...\n")
...
# 5. Utility Packages
# ==============================================================================
cat("\n[5/7] Installing Utility packages...\n")
...
# ==============================================================================
cat("\n[6/7] Installing Reporting packages...\n")
